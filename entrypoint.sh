...
REQUIRED_VARS="GOOGLE_GENAI_USE_VERTEXAI MAPS_API_KEY GOOGLE_CLOUD_PROJECT GOOGLE_CLOUD_LOCATION LANGFUSE_SECRET_KEY LANGFUSE_PUBLIC_KEY LANGFUSE_HOST TRANSPORT_API_ID TRANSPORT_API_KEY"
MISSING=0
